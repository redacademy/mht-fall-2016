<?php
 /**
 *
 * @package   The mountain health team Functionality
 * @author    Hanin Sasha kayden <haninmustafa13@email.com>
 * @license   GPL-2.0+
 * @copyright Mountain Health Co.
 *
 * @wordpress-plugin
 * Plugin Name: The mountain health team Functionality
