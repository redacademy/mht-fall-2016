(function($) {
    ...
    $(function() {
        ...
        $(".about-page  header p, .front-page  header p, .single-article-page header p").addClass("phone-number-white");
        $(".about-page  header .phone-blue, .front-page  header .phone-blue, .single-article-page header .phone-blue").hide();
        $(".about-page  header .MTH-logo-dt, .front-page  header .MTH-logo-dt, .single-article-page header .MTH-logo-dt").hide();
        $(".about-page  header .MTH-logo-white, .front-page  header .MTH-logo-white, .single-article-page header .MTH-logo-white").show();
        $(".about-page  header .phone-and-number .phone-white, .front-page  header .phone-and-number .phone-white, .single-article-page header .phone-and-number .phone-white").show();
        $(".about-page .search-icon-dt, .front-page .search-icon-dt, .single-article-page .search-icon-dt").hide();
        $(".about-page .external-link-logo-dt, .front-page .external-link-logo-dt, .single-article-page .external-link-logo-dt").hide();
        $(".about-page .external-link-logo-white-dt, .front-page .external-link-logo-white-dt, .single-article-page .external-link-logo-white-dt").show();
        $(".search-logo-white-dt").hide();
        $(".about-page header .search-logo-white-dt, .front-page header .search-logo-white-dt , .single-article-page header .search-logo-white-dt").show();
        $(".about-page .header-button, .front-page .header-button , .single-article-page header-button").addClass("header-button-white");
        $(".single-article-page .desktop-menu a, .single-article-page header .patient-portal-desktop a, .single-article-page .phone-header").css("color", "white");

        $(window).on("scroll", function() {
            if ($(window).scrollTop() > 1) {
                $(".about-page  header, .front-page header, .single-article-page header").addClass("header-white");
                $(".about-page  header .hamburger-white, .front-page  header .hamburger-white, .single-article-page header .hamburger-white").removeClass("hamburger");
                $(".about-page  header p, .front-page  header p, .single-article-page header p").removeClass("phone-number-white");
                $(".about-page  header .phone-blue, .front-page  header .phone-blue, .single-article-page header .phone-blue").show();
                $(".about-page  header .MTH-logo-dt, .front-page  header .MTH-logo-dt, .single-article-page header .MTH-logo-dt").show();
                ...
                $(".about-page header .patient-portal-desktop a, .front-page header .patient-portal-desktop a, .single-article-page header .patient-portal-desktop a").css("color", "#1a9481");
                $(".about-page .header-button, .front-page .header-button, .single-article-page .header-button").removeClass("header-button-white");
                $(".single-article-page .phone-header").css("color", "#1a9481");


            } else {
                $(".about-page  header, .front-page  header, .single-article-page header").removeClass("header-white");
                $(".about-page .hamburger-white, .front-page  header .hamburger-white, .single-article-page header .hamburger-white").addClass("hamburger");
                $(".about-page  header p, .front-page  header p, .single-article-page header p").addClass("phone-number-white");
                $(".about-page  header .MTH-logo-dt, .front-page  header .MTH-logo-dt, .single-article-page header .MTH-logo-dt").hide();
                $(".about-page  header .MTH-logo-white, .front-page  header .MTH-logo-white, .single-article-page header .MTH-logo-white").show();
                $(".about-page  header .phone-blue, .front-page  header .phone-blue, .single-article-page header .phone-blue").hide();
                $(".about-page  header .phone-and-number .phone-white, .front-page  header .phone-and-number .phone-white, .single-article-page header .phone-and-number .phone-white").show();
                $(".about-page .search-icon-dt, .front-page .search-icon-dt, .single-article-page .search-icon-dt").hide();
                $(".about-page .search-logo-white, .front-page .search-logo-white, .single-article-page .search-logo-white").show();
                $(".about-page .external-link-logo-dt, .front-page .external-link-logo-dt, .single-article-page .external-link-logo-dt").hide();
                $(".about-page .external-link-logo-white-dt, .front-page .external-link-logo-white-dt, .single-article-page .external-link-logo-white-dt").show();
                $(".about-page .desktop-menu a, .front-page .desktop-menu a, .single-article-page .desktop-menu a").css("color", "white");
                $(".about-page header .patient-portal-desktop a, .front-page header .patient-portal-desktop a, .single-article-page header .patient-portal-desktop a").css("color", "white");
                $(".about-page header .search-logo-white-dt, .front-page header .search-logo-white-dt, .single-article-page header .search-logo-white-dt").show();
                $(".about-page .header-button, .front-page .header-button, .single-article-page .header-button").addClass("header-button-white");
                $(".single-article-page .phone-header").css("color", "white");
